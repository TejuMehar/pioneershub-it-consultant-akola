...
const TeamCTA = () => {
  return (
    <section className="relative overflow-hidden py-24 bg-gradient-to-br from-gray-100 via-gray-200 to-gray-300 text-gray-900 flex items-center justify-center">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        <a
          href="/contact"
          className="inline-block px-10 py-4 rounded-xl font-semibold bg-gray-900 text-white shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300"
        >
          View Open Positions
        </a>

        {/* Decorative bottom line */}
        <div className="mt-10 w-32 h-1 bg-gradient-to-r from-gray-400 to-gray-500 mx-auto rounded-full" />
      </div>

      {/* Fade at bottom */}
      <div className="absolute bottom-0 left-0 w-full h-24 bg-gradient-to-b from-transparent to-gray-300 pointer-events-none" />
    </section>
  );
};
