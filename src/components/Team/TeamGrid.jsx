    ...
    <section className="py-12 sm:py-16 lg:py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* <div className="text-center">
          <h2 className="text-2xl sm:text-3xl md:text-4xl xl:text-5xl font-bold text-gray-500 mb-8 sm:mb-10 md:mb-12">
            Meet the Team
          </h2>
        </div> */}
          ...
          {team.map((member, index) => (
            <div key={index} className="px-4 sm:px-0">
              <img
                ...
                alt={member.name}
              />
              <h3 className="mt-4 sm:mt-5 text-base sm:text-lg xl:text-xl font-bold text-gray-900">{member.name}</h3>
              <p className="mt-2 text-sm sm:text-base text-gray-600">{member.role}</p>
              <p className="mt-2 text-xs sm:text-sm text-gray-500 px-2 sm:px-0">{member.bio}</p>

              {/* Social Links */}
              <div className="flex justify-center gap-2 sm:gap-3 mt-3 sm:mt-4">
                <a
                  href={member.social.linkedin}
                  className="w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center rounded-lg bg-gray-100 hover:bg-blue-600 hover:text-white transition"
                >
                ...
                {/* <a
                  ...
                  className="w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center rounded-lg bg-gray-100 hover:bg-blue-400 hover:text-white transition"
                >
                  <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="currentColor" viewBox="0 0 24 24">
                ...
                {/* <a
                  ...
                  className="w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center rounded-lg bg-gray-100 hover:bg-red-500 hover:text-white transition"
                >
